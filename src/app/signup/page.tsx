...
import { Gamepad2, Mail, Lock, UserPlus, ChevronLeft, User } from 'lucide-react';
...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert("Account creation feature is coming soon!");
  };
        ...
        <Card className="glass-panel border-white/10 rounded-[2.5rem] shadow-2xl overflow-hidden">
          ...
          <CardContent className="space-y-6 px-8 pb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full h-14 bg-secondary hover:bg-secondary/90 text-background font-bold text-lg rounded-xl shadow-[0_0_20px_rgba(26,223,255,0.2)]">
                CREATE ACCOUNT
              </Button>
            </form>
          </CardContent>
